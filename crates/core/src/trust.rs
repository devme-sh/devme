...
mod tests {
    ...
    fn serializes_to_lowercase() {
        ...
        assert_eq!(
            serde_json::to_string(&Trust::Prompt).unwrap(),
            r#""prompt""#
        );
        assert_eq!(
            serde_json::to_string(&Trust::Manual).unwrap(),
            r#""manual""#
        );
    }
    ...
    fn deserializes_all_variants() {
        assert_eq!(
            serde_json::from_str::<Trust>(r#""auto""#).unwrap(),
            Trust::Auto
        );
        assert_eq!(
            serde_json::from_str::<Trust>(r#""prompt""#).unwrap(),
            Trust::Prompt
        );
        assert_eq!(
            serde_json::from_str::<Trust>(r#""manual""#).unwrap(),
            Trust::Manual
        );
    }
