...
**Two-phase model (`devme setup` then `devme`).** Cleaner separation but forces a mode switch on the user. Breaks the "type `devme` and it works" promise. Out.
